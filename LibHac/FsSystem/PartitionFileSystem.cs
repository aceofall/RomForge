    ...
    where TEntry : unmanaged, IPartitionFileSystemEntry
{
    ...
    protected override Result DoOpenFile(ref UniqueRef<IFile> outFile, ref readonly Path path, OpenMode mode)
    {
        ...
        using UniqueRef<PartitionFile> file = new(new PartitionFile(this, in _metaData.GetEntry(entryIndex), mode));
        if (!file.HasValue)
    ...
    protected override Result DoOpenDirectory(ref UniqueRef<IDirectory> outDirectory, ref readonly Path path, OpenDirectoryMode mode)
    {
        ...
        using UniqueRef<PartitionDirectory> directory = new(new PartitionDirectory(this, mode));
