...
public sealed class RepackService
{
    ...
    public static void Repack(ITitleSource source, string outputWuaPath, string? patchFolder = null, string? titleIdHexOverride = null, int? titleVersionOverride = null, Action<int, int, string>? onFileProgress = null, CancellationToken cancellationToken = default)
    {
